...
const TableBodyFragment = (props: TableBodyProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <td className="p-3 flex justify-start items-center gap-5 text-left">
        <Image
      ...
      <td className=" px-4">
        <button
          className="bg-orange-600 px-2 py-2 w-full rounded-md text-slate-100 capitalize font-semibold transition-all duration-200 hover:bg-orange-800"
          type="button"
        >
          edit
        </button>
